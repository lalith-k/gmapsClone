...
function Se(t, i, e, n) {
  return i.map((o, s) => {
    ...
    let l = 0;
    const c = a.map((y, g) => {
      const _ = r.slice(l).findIndex((w) => Ue(t, w, y)), E = g === a.length - 1;
      if (_ !== -1)
        l += _;
      else if (E)
        return r.length - 1;
...
function Te(t, i, e, n, o, s, r = null, a = [-1]) {
  ...
  }) : [], c.update(), d = !0, G(c.before_update), c.fragment = n ? n(c.ctx) : !1, i.target) {
    if (i.hydrate) {
      const p = Je(i.target);
  ...
  return {
    ...
    m(p, f) {
      B(p, i, f), Q(
        ...
        /*waypointBearing*/
        t[16].degrees
      ), B(p, r, f), B(p, a, f), l || (c = F(i, "input", d), l = !0);
    },
    p(p, f) {
...
function _e(t) {
  let i, e, n, o, s, r, a, l, c, d, p, f = (
    /*i*/
    t[18]
  ), y, g, _, E, w, b, m, v, R, C, x, W, T, U, ne;
  function Oe() {
    t[7].call(
      o,
      /*each_value*/
